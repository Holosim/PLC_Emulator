...
| OUT-402 | Server detects simulation-client disconnect, logs the event (per UI-002's diagnostics), and continues running/accepting a new connection without crashing or requiring a restart. | SN-1 | Test | Verified | |
