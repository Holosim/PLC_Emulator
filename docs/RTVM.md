...
| DATA-OUT-300 | Internal runtime state model holds current values for every tag (including timer/counter sub-elements) and is updated at the end of every scan cycle, queryable by the rest of the system. | SN-1 | Test | Verified | `0b362e8` |
