...
| OUT-401 | Server accepts JSON write messages from the connected simulation client to set input tag values (e.g. simulated sensor states); writes are applied to the internal model and take effect on the next scan cycle. | SN-1, SN-3 | Test | Verified | `0242894` |
