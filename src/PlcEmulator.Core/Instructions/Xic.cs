...
public sealed class Xic : SingleTagInstruction
{
    ...
    /// <summary>Condition-type: ANDs the tag's current value into the incoming rung state and returns the result (CORE-201). Ignores <paramref name="elapsed"/> — not time-driven.</summary>
