...
public sealed class CompareInstructionTests
{
    ...
    public void Tp207_Grt_TagVsLiteral_MatchesExpectedTruthTable()
    {
        ...
        Assert.IsTrue(grt.Evaluate(tags, rungState: true), "Preset_Count=6 should be > 5");

        tags.Set("Preset_Count", 4);
        Assert.IsFalse(grt.Evaluate(tags, rungState: true), "Preset_Count=4 should not be > 5");
    }
    ...
    public void Equ_TagVsLiteral_TrueOnlyWhenEqual()
    {
        ...
        Assert.IsTrue(equ.Evaluate(tags, rungState: true));

        tags.Set("Preset_Count", 6);
        Assert.IsFalse(equ.Evaluate(tags, rungState: true));
    }
    ...
    public void Neq_TagVsLiteral_TrueOnlyWhenDifferent()
    {
        ...
        tags.Set("Preset_Count", 5);
        Assert.IsFalse(neq.Evaluate(tags, rungState: true));

        tags.Set("Preset_Count", 6);
        Assert.IsTrue(neq.Evaluate(tags, rungState: true));
    }
    ...
    public void Les_TagVsLiteral_TrueOnlyWhenStrictlyLess()
    {
        ...
        tags.Set("Preset_Count", 4);
        Assert.IsTrue(les.Evaluate(tags, rungState: true));

        tags.Set("Preset_Count", 5);
        Assert.IsFalse(les.Evaluate(tags, rungState: true));
    }
    ...
    public void Geq_TagVsLiteral_TrueWhenGreaterOrEqual()
    {
        ...
        tags.Set("Preset_Count", 5);
        Assert.IsTrue(geq.Evaluate(tags, rungState: true));

        tags.Set("Preset_Count", 4);
        Assert.IsFalse(geq.Evaluate(tags, rungState: true));
    }
    ...
    public void Leq_TagVsLiteral_TrueWhenLessOrEqual()
    {
        ...
        tags.Set("Preset_Count", 5);
        Assert.IsTrue(leq.Evaluate(tags, rungState: true));

        tags.Set("Preset_Count", 6);
        Assert.IsFalse(leq.Evaluate(tags, rungState: true));
    }
    ...
    public void Grt_TagVsTag_DintAndReal_ComparesNumerically()
    {
        ...
        Assert.IsTrue(grt.Evaluate(tags, rungState: true));
    }
    ...
    public void Evaluate_FalseIncomingRungState_ResultIsAlwaysFalse()
    {
        ...
        Assert.IsFalse(grt.Evaluate(tags, rungState: false));
    }
    ...
    public void Evaluate_BoolTagOperand_ThrowsInvalidOperationException()
    {
        ...
        Assert.ThrowsException<InvalidOperationException>(() => equ.Evaluate(tags, rungState: true));
    }
